...
class OtolaryngologistTest {
    ...
    void testPatient(){
        ...
        assertEquals(queue.peek().getSessionTime().format(formatter), LocalDateTime.now().plusSeconds((long) (17/1.5)).format(formatter));
        ...
        result = LocalDateTime.now().plusSeconds((long) (13 / 1.25));
